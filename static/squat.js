function fetchCounts() {
    fetch('/get_squat_counts')
        .then(response => response.json())
        .then(data => {
            document.getElementById("squat-stage").textContent = data.squat_stage || "Waiting...";
            // document.getElementById("right-stage").textContent = data.right_squat_stage || "Waiting...";
            document.getElementById("squat-count").textContent = data.squat_counter;
